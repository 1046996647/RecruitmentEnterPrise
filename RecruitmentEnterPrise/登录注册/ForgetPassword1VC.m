...
- (void)viewDidLoad {
    ...
    UILabel *phoneLab = [UILabel labelWithframe:CGRectMake(0, titleLab.bottom+6, kScreenWidth, 20) text:ServerPhone font:[UIFont systemFontOfSize:14] textAlignment:NSTextAlignmentCenter textColor:@"#666666"];
